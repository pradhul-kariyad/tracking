        ...
        children: [
          Stack(
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 97.w, top: 50.h, right: 21.w),
                child: SizedBox(
                  height: 40.h,
                  width: 290.w,
                  child: TextFormField(
              ...
              Padding(
                padding: EdgeInsets.only(left: 97.w, top: 94.h, right: 21.w),
                child: SizedBox(
                  height: 40.h,
                  width: 290.w,
                  child: TextFormField(
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border.all(width: 1.sp, color: Color(0xffDBDBDB)),
                        ...
                        child: Column(
                          children: [
                            Text(
                              "Thalassery",
                              style: TextStyle(
                                  color: Color(0xff383434), fontSize: 14.sp),
                            ),
                            Text(
                              "Kerala, India",
                              style: TextStyle(
